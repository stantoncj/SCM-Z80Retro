...
kConfMajor = 'J'            ;Config Letter = official, number = user
...
kConfHardw = HW_SC126       ;Hardware identifier (if known)
...
kZ180Base  = 0x00           ;Z180 internal register base address

; Simple I/O ports
kPrtIn     = 0x00           ;General input port
kPrtOut    = 0x0D           ;General output port
...
; Memory map
kCode      = 0x2000         ;Typically 0x0000 or 0xE000
kData      = 0x4C00         ;Typically 0xFC00 (to 0xFFFF)
