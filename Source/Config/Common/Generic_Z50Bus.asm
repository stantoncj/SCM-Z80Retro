...
kACIA1     = 0xA2           ;Base address of serial ACIA #1
	DEFINE+ INCLUDE_ACIA_n1 ;Include ACIA #1 support in this build
	ENDIF

	IFNDEF INCLUDE_ACIA_n2
kACIA2     = 0xA4           ;Base address of serial ACIA #2
...
kDigIO     = 0xA0           ;Base address of digital IO port
...
; Diagnostic LEDs 
	...
	ENDIF
kDiagLEDs  = 0xA0           ;Base address of diagnostic LEDs
